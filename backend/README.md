...
## Project Structure
    ...
    ├── crm_hospitality_tem_38032  # Django project configurations
...
1. Clone this repo and `cd crm_hospitality_tem_38032`
...
2. Clone this repo and `cd crm_hospitality_tem_38032`
